...
public class DaftarMeja extends javax.swing.JFrame {
    ...
    public void SelectData(){
        ...
        if(i == -1){
            return;
        }String s = (String) tblmeja.getModel().getValueAt(i, 1);
    }
    ...
    private void initComponents() {
        ...
        tblmeja.setPreferredSize(new java.awt.Dimension(650, 466));
    ...
    private void tblmejaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblmejaMouseClicked
        ...
        String id_meja = tblmeja.getValueAt(i, 0).toString();
        FromTransaksi.txtidmeja.setText(id_meja);
