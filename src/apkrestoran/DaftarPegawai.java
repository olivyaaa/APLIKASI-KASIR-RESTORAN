...
public class DaftarPegawai extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblpegawai.setPreferredSize(new java.awt.Dimension(650, 466));
    ...
    private void tblpegawaiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblpegawaiMouseClicked
        ...
        String nama = tblpegawai.getValueAt(i, 1).toString();
        String jenis = tblpegawai.getValueAt(i, 2).toString();
        FromLaporanTransaksi.lbidpegawai.setText(id);
        FromLaporanTransaksi.lbnamapegawai.setText(nama);
        FromLaporanTransaksi.lbjabatan.setText(jenis);
